...
def new_project():
    ...
    project = Project(project_id=23, description="TDD lessons",
                      name="TDD", last_activity="2020-02-19")
    return project
...
def test_new_project(new_project):
    ...
    assert new_project.last_activity == "2020-02-19"


def test_presence_and_absence_project(test_app, new_project):
...
def test_counting_identical_items(test_app):

    p1 = Project(project_id=1, description="row",
                 name="Count", last_activity="2015-02-1")

    p2 = Project(project_id=2, description="row",
                 name="Count", last_activity="1995-12-2")
